...
1. Menu **Couche → Ajouter une couche → Ajouter une couche XYZ**
1. Liste déroulante **Connexions XYZ → OpenStreetMap**
1. Bouton **Ajouter**
...
Si nous devions ajouter des couches exprimées dans un autre SCR, 
