...
il faut extraire les pages intéressantes, récupérer les données textuelles , 
nettoyer le fichier, géocoder les adresses puis charger la couche.


### Une page

Comme dans la partie précédente, on va commencer par se faire la main sur
une seule page d'adresses, avant de voir comment généraliser. On restera
...
Pour extraire la page, on peut utiliser 
...
![](/resources/plu-bio/acrobatpro.jpeg)
...
Pour les besoins du cours vous pouvez utiliser la clé API suivante :

```{sh}
H1qZ3YHuNPJR6ueRTpcYEyphdrTilu8wZR3bxPAK
```

![](/resources/plu-bio/extracttable.jpeg)

Le fichier Excel en résultant est téléchargeable
...
[ici](/resources/plu-bio/p51.pdf-clean.geocoded.xlsx) en CSV 
si besoin.
...
à accorder aux résultats via le champ `result_score`.

![](/resources/plu-bio/imprecisions)
...
- Dédupliquer les lignes contenant plusieurs adresses en utilisant une
  expression régulière pour les détecter

Voici la [carte](https://umap.openstreetmap.fr/fr/map/plub-carte-des-emplacements-reserves-logements_940982) 
ainsi constituée des emplacements réservés tels qu'ils étaient avant
l'enquête publique, et la 
[couche](plub_carte_des_emplacements_reserves_logements_2023.geojson)
(au format GeoJSON) des données qu'elle représente.

Identifiez-vous sur la feuille D5 des emplacements réservés qui ont disparu
...
y avait déjà 
un [projet engagé](https://www.studiohoxha.com/salle-de-sport-residence-paris-16/)
...
![](/resources/plu-bio/ligne_commande_par_exemple.jpg]
