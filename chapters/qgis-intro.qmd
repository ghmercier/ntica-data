...
- Une [page internet](https://www.inventerlegrandparis.fr/seminaire-igp/seminaire-igp-2019-2020/amenager-la-banlieue-parisienne-production-et-evolution-des-grands-equipements-structurants/le-val-deurope-a-marne-la-vallee-variations-sur-un-parc-a-theme/) où trouver l'image source.
- Mettre la [BD Parcellaire](https://cartes.gouv.fr/rechercher-une-donnee/dataset/IGNF_BD-PARCELLAIRE) en fond pour trouver des points de contrôle
- Le géoréférenceur est disponible via le menu  **Couches → Géoréférenceur**.
- Les points de contrôle que j'ai utilisés sont [ici](/resources/intro-qgis/ill3-plan-masse-secteur-4-wing-chao-vs-jean-poulit-mars-1987.jpg.points)

### Géocodage d'adresses

Saurez-vous créer une semis de points à partir d'une liste d'adresse ?

### Buffers / zones tampons

Saure-vous calculer des zones tampons ?
